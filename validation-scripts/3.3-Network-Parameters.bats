...
@test "3.3.1 Ensure source routed packets are not accepted (Scored)" {
...
@test "3.3.2 Ensure ICMP redirects are not accepted (Scored)" {
...
@test "3.3.3 Ensure secure ICMP redirects are not accepted (Scored)" {
...
@test "3.3.4 Ensure suspicious packets are logged (Scored)" {
...
@test "3.3.5 Ensure broadcast ICMP requests are ignored (Scored)" {
...
@test "3.3.6 Ensure bogus ICMP responses are ignored (Scored)" {
...
@test "3.3.7 Ensure Reverse Path Filtering is enabled (Scored)" {
...
@test "3.3.8 Ensure TCP SYN Cookies is enabled (Scored)" {
...
@test "3.3.9 Ensure IPv6 router advertisements are not accepted (Scored)" {
